@echo off
set "sourceFolder=E:\scritturaTesiMagistrale\sample_non_maligni"
set "destinationFolder=E:\scritturaTesiMagistrale\VM\MalwareAnalysis\shared\samples"
...
for %%i in ("%sourceFolder%\*") do (
	...
	start C:\Programmi\Oracle\VirtualBox\VBoxManage guestcontrol %vmName% run --username student --password reverse --exe C:\Users\student\AppData\Local\Programs\Python\Python311\python.exe -- python.exe C:\Users\student\Desktop\automated_dump.py 
